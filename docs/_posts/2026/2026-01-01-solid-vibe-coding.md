...
足足聽了一整年 "工程師要被 AI 取代了 blah blah" 這類的觀點, 我其實沒有很認同, 100% 確定會被取代的, 我認為是 Programmer, 但是能思考解決問題方法的人才 ( engineer, tech lead, architect 等等 ) 我覺得發揮空間更大了, 應該會越來越搶手吧? 這類話題討論到最後都是沒有結果的, 所以我就換個方式, 實際拿一個案例, 用兩種方法各自讓 coding agent 來做一次, 對照看一下差異再來下結論吧

我直接講我實驗的結果, 有興趣看過程的可以往下看｡ 同樣的題目, 我用兩種角色設定來開發, 然後對照看 AI 的開發成果:
...
結果當然是實驗組的表現比較好, 這是可預期的, 但是我想表達的是: 實驗組 的開發過程到底是怎麼做的? 各位可以從這些過程中反思, 哪些環節仍然必須依賴有經驗的人來進行, 目前還無法靠 AI 來替代? 掌握這些差異, 有助於各位仔細思考未來團隊需要準備什麼樣的角色, 各位自身的能力該往什麼樣的領域發展｡
