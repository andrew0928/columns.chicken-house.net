...
### 3. 圖片和多媒體
- 圖片放置在 `/assets/images/{year}/` 目錄
- 檔名使用 `{post-slug}-{sequence}.{ext}` 格式
- 必須提供 alt 文字描述
- 範例：`![Docker 容器架構圖](/assets/images/2024/docker-setup-01.png)`

### 4. 連結規範
- **內部連結**：使用相對路徑，格式 `[文字](/yyyy/mm/dd/post-title/)`
