...
因此，我寫這主題的第一件事，就是先建立解題的模型。權限管控的基礎建設，就是認證與授權。我直接從 .NET 處理這件事的基本介面開始看吧，我從 .NET 1.1 那個年代就開始寫 C# 了，我想能比我還清楚這些歷史的人應該不多了吧? 不得不說 Microsoft 在這件事的設計上相當漂亮，早在當年 .NET 1.1 的年代就已經存在的兩個介面，大概就能回答這個問題了。這兩個介面分別是:
