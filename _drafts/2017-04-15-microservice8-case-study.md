...
四個場子的屬性都不大一樣，每場講的主題都圍繞在 .NET + Microservices + Windows Container, 只不過重點擺的地方都不同。
